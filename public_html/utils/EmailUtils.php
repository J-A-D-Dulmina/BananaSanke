...
class EmailUtils {
    private const FROM_EMAIL = "Your email";
    private const EMAIL_PASSWORD = "Yourcefv MAIL PASSWORD";
    private const SMTP_HOST = "Your SMTP_HOST";
    private const SMTP_PORT = "Your Port";

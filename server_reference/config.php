...
define('DB_NAME', 'deshand1_BananaSnake_db');  // Your actual database name
define('DB_USER', 'deshand1_game');            // Your actual database username
define('DB_PASS', 'deshan@30840');             // Your actual database password
...
// Security settings
define('ALLOWED_ORIGINS', ['https://deshandulmina.info']);  // Add your domains
